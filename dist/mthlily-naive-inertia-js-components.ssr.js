'use strict';var naiveUi=require('naive-ui'),vue=require('vue'),route=require('ziggy-js'),_=require('lodash'),inertia=require('@inertiajs/inertia'),inertiaVue3=require('@inertiajs/inertia-vue3');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var route__default=/*#__PURE__*/_interopDefaultLegacy(route);var ___default=/*#__PURE__*/_interopDefaultLegacy(_);function ownKeys(object, enumerableOnly) {
...
function _nonIterableRest() {
...
};var useLaravelDataTable = function useLaravelDataTable(paginationData, unprocessedColumns, adaptor) {
  ...
  filterColumns.forEach(function (column) {
    if (column.filterType === "text") vue.watch(column, ___default["default"].throttle(handleTextFilter, 1000));
    if (column.filterType === "daterange") vue.watch(column, handleDateRangeFilter);
  });
  return {
    columns: columns,
  ...
  setup: function setup(props) {
    ...
    var handleTextFilterUpdate = function handleTextFilterUpdate(value) {
      console.log(value);
    };

    return {
      handleTextFilterUpdate: handleTextFilterUpdate,
      pagination: pagination,
      datatable: datatable,
      route: route__default["default"],
      loading: loading
    };
  }
  ...
  return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [vue.createVNode(_component_n_space, {
    vertical: ""
  }, {
    ...
    _: 1
  }), vue.createTextVNode(" " + vue.toDisplayString(_ctx.datatable.columns), 1)], 64);
}script$3.render = render$3;var useInertiaAdaptor = function useInertiaAdaptor() {
  ...
  var getQuery = function getQuery() {
    var query = window.location.search.substring(1).split("&").map(function (queryPart) {
      return queryPart.split("=");
    }).reduce(function (carry, queryPart) {
      var queryPair = {};
      queryPair[queryPart[0]] = queryPart[1];
      return Object.assign(carry, queryPair);
    }, {});
    console.log(route__default["default"]().params, query);
...
}script.render = render;var useInertiaFormItem = function useInertiaFormItem() {
...
};var useInertiaFormHelper = function useInertiaFormHelper() {
  ...
  var generateModelForm = function generateModelForm(args) {
    var toModelForm = function toModelForm() {
      ...
      if (model === null) {
        ...
        if (args.complexKeys) for (var _i = 0, _Object$entries = Object.entries(args.complexKeys); _i < _Object$entries.length; _i++) {
          ...
          Object.assign(_values, _defineProperty({}, key, getters === null || getters === void 0 ? void 0 : getters.get()));
        }
        return inertiaVue3.useForm(_values);
      }

      var values = args.simpleKeys ? ___default["default"].pick(model, args.simpleKeys) : {};
      if (args.complexKeys) for (var _i2 = 0, _Object$entries2 = Object.entries(args.complexKeys); _i2 < _Object$entries2.length; _i2++) {
        var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i2], 2),
            _key = _Object$entries2$_i[0],
            _getters = _Object$entries2$_i[1];

        values[_key] = _getters.set ? _getters.set(model) : model[_key];
      }
...
};var components$1=/*#__PURE__*/Object.freeze({__proto__:null,NLaravelDataTable:script$3,NInertiaDataTable:script$2,NLaravelPagination:script$1,useDefaultAdaptor:useDefaultAdaptor,useInertiaAdaptor:useInertiaAdaptor,NInertiaFormItem:script,useInertiaFormItem:useInertiaFormItem,useInertiaFormHelper:useInertiaFormHelper});var install = function installMthlilyNaiveInertiaJsComponents(app) {
...
var components=/*#__PURE__*/Object.freeze({__proto__:null,'default':install,NLaravelDataTable:script$3,NInertiaDataTable:script$2,NLaravelPagination:script$1,useDefaultAdaptor:useDefaultAdaptor,useInertiaAdaptor:useInertiaAdaptor,NInertiaFormItem:script,useInertiaFormItem:useInertiaFormItem,useInertiaFormHelper:useInertiaFormHelper});// only expose one global var, with component exports exposed as properties of
